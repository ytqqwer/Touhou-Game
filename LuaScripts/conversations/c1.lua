dialogues = {
   function()
      clayer:changeBgp('gamedata/conversations/c1_bgp.png')
         ...
         :changeCharacter('LEFT', 'Kirisame Marisa', {r=0xff, g=0xf8, b=0x7c},
   ...
   function()
      clayer:changeCharacter('RIGHT', 'Hakurei Reimu', {r=0xfe, g=0x46, b=0x2b},
   ...
   function()
      clayer:changeText('Hakurei Reimu', '很冷啊，快把门关上好。')
         :playerSoundEffect('se/surprise.wav')
   end,
